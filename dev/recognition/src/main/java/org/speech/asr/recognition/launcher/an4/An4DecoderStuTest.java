 ...
 * <p/>
 * Creation date: Sep 2, 2009 <br/>
 * <a href="http://www.grapesoftware.com">www.grapesoftware.com</a>
 *
 * @author Lukasz Olczak
 */
public class An4DecoderStuTest {
  /**
   * slf4j Logger.
   */
  private static final Logger log = LoggerFactory.getLogger(An4DecoderStuTest.class.getName());
  ...
  public void start() {
    ...
    transcriptionFile = new File("/mnt/work/an4/test-stu.txt");
    featureDir = new File("/mnt/work/an4/an4-8/feat");
    modelFile = new File("/mnt/work/an4/iteration08.xml");
  ...
  protected void initDecoder(List<Item> testSet) {
    ...
    searchManager.setBeamWidth(10);

    An4StuSearchGraphBuilder builder = new An4StuSearchGraphBuilder();
