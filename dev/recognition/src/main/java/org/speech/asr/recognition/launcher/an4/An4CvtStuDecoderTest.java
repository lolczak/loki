 ...
 */
public class An4CvtStuDecoderTest {
  /**
   * slf4j Logger.
   */
  private static final Logger log = LoggerFactory.getLogger(An4CvtStuDecoderTest.class.getName());
  ...
  public static void main(String[] args) {
    new An4CvtStuDecoderTest().start();
  }
  ...
  public void start() {
    ...
    modelFile = new File("/mnt/work/an4/nn_epoch01.xml");
  ...
  protected void initDecoder(List<Item> testSet) {
    ...
    searchManager.setBeamWidth(700);
